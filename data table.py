...
tree = ttk.Treeview(win, column=("Batch ID", "Timestamp", "Reading 1", "Reading 2", "Reading 3", "Reading 4", "Reading 5", "Reading 6", "Reading 7", "Reading 8", "Reading 9", "Reading 10"), show='headings', height=50) # Create the headings for each of the columns of the table.

tree.column("# 1", anchor=CENTER) # Adds a column to the table
tree.heading("# 1", text="Batch ID") # Adds the text for the column name

tree.column("# 2", anchor=CENTER) # Adds a column to the table
tree.heading("# 2", text="Timestamp") # Adds the text for the column name

tree.column("# 3", anchor=CENTER) # Adds a column to the table
tree.heading("# 3", text="Reading 1") # Adds the text for the column name

tree.column("# 4", anchor=CENTER) # Adds a column to the table
tree.heading("# 4", text="Reading 2") # Adds the text for the column name

tree.column("# 5", anchor=CENTER) # Adds a column to the table
tree.heading("# 5", text="Reading 3") # Adds the text for the column name

tree.column("# 6", anchor=CENTER) # Adds a column to the table
tree.heading("# 6", text="Reading 4") # Adds the text for the column name

tree.column("# 7", anchor=CENTER) # Adds a column to the table
tree.heading("# 7", text="Reading 5") # Adds the text for the column name

tree.column("# 8", anchor=CENTER) # Adds a column to the table
tree.heading("# 8", text="Reading 6") # Adds the text for the column name

tree.column("# 9", anchor=CENTER) # Adds a column to the table
tree.heading("# 9", text="Reading 7") # Adds the text for the column name

tree.column("# 10", anchor=CENTER) # Adds a column to the table
tree.heading("# 10", text="Reading 8") # Adds the text for the column name

tree.column("# 11", anchor=CENTER) # Adds a column to the table
tree.heading("# 11", text="Reading 9") # Adds the text for the column name

tree.column("# 12", anchor=CENTER) # Adds a column to the table
tree.heading("# 12", text="Reading 10") # Adds the text for the column name
############################################

with open("Data.csv", 'r') as file: # Opens the csv file in read mode
    ...
    for rows in csvreader: # For loop for adding each row of data to the table to be displayed
        tree.insert('', 'end', text="1", values=(rows[0],rows[1],rows[2],rows[3],rows[4],rows[5],rows[6],rows[7],rows[8],rows[9],rows[10],rows[11])) # Adds the data from one row of the table
